...
const Contact = () => {
  ...
  return (
    <div className='px-6 max-w-[1000px] mx-auto glass grid md:grid-cols-2 place-items-center lg:mt-20 mt-6' id='contact'>
      <div className='m-5 pr-6 '>
        <motion.h3
          whileInView={{ opacity: 1, y: 0 }}
          initial={{ opacity: 0, y: -100 }}
          transition={{ duration: 0.5 }} className='lg:text-5xl text-2xl font-bold text-gray-200 underline underline-offset-4 mb-3 text-center'>Contact Me </motion.h3>
        <div className='mt-2'>
          ...
          <motion.p
            ...
            className='text-gray-400 text-sm lg:text-2xl flex  items-center gap-2 mb-2'> <FaPhoneAlt size={20} />+91 7788868075 / 9348659078</motion.p>
          <motion.p
            whileInView={{ opacity: 1, x: 0 }}
            initial={{ opacity: 0, x: -100 }}
            transition={{ duration: 0.5 }}
            className='text-gray-400 text-sm lg:text-2xl flex  items-center gap-2 mb-2'><SiGmail size={20} />kumar.bikash.gouda@gmail.com</motion.p>
          <motion.p
            whileInView={{ opacity: 1, x: 0 }}
            initial={{ opacity: 0, x: -100 }}
            transition={{ duration: 0.5 }}
            className='text-gray-400 text-sm lg:text-2xl flex  items-center gap-2 mb-2'><FaLocationDot size={20} />Benguluru, India</motion.p>
        </div>
